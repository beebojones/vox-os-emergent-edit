...
async def google_login(request: Request):
    ...
    # Use voxos-ai.preview.emergentagent.com as the canonical OAuth redirect
    redirect_uri = "https://voxos-ai.preview.emergentagent.com/api/auth/google/callback"
...
async def google_callback(request: Request, code: str = None, error: str = None):
    ...
    # Use voxos-ai as the canonical frontend URL
    frontend_url = "https://voxos-ai.preview.emergentagent.com"
    ...
    try:
        # Use voxos-ai for the callback redirect URI
        callback_redirect_uri = "https://voxos-ai.preview.emergentagent.com/api/auth/google/callback"
